...
public class LongestSubstringWORepeat {
    ...
    If you encounter a repeating character, you won’t be able to include the new character till you exclude the previous occurrence of this character.
    This means your window needs to shrink till your start character is pointing to the position next to the previous occurrence of the character.
     */
